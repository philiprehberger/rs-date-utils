...
[![GitHub release](https://img.shields.io/github/v/release/philiprehberger/rs-date-utils)](https://github.com/philiprehberger/rs-date-utils/releases)
[![Last updated](https://img.shields.io/github/last-commit/philiprehberger/rs-date-utils)](https://github.com/philiprehberger/rs-date-utils/commits/main)
[![License](https://img.shields.io/github/license/philiprehberger/rs-date-utils)](LICENSE)
[![Bug Reports](https://img.shields.io/github/issues/philiprehberger/rs-date-utils/bug)](https://github.com/philiprehberger/rs-date-utils/issues?q=is%3Aissue+is%3Aopen+label%3Abug)
[![Feature Requests](https://img.shields.io/github/issues/philiprehberger/rs-date-utils/enhancement)](https://github.com/philiprehberger/rs-date-utils/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
...
```toml
[dependencies]
philiprehberger-date-utils = "0.1.3"
```
